...
namespace DMSFrame
{
    ...
    public class DMST
    {
        ...
        protected DMST(Type type, string bDataBase, bool bWithLock, bool bNeedParams, bool bNeedQueryProvider)
        {
        ...
        protected DMST(Type type, DMST dms)
        {
        ...
        /// <param name="bDataBase"></param>
        /// <returns></returns>
        internal static DMST Create(object entity, Type type, string bDataBase)
        {
            DMST instance = new DMST(type, bDataBase, ConstExpression.WithLock, ConstExpression.NeedParams, ConstExpression.NeedQueryProvider);
        ...
        {
            Type type = typeof(DMST.MssqlObject);
            if (dbType != DMSDbType.MsSql)
            {
                switch (dbType)
                {
                    case DMSDbType.Access:
                        type = typeof(DMST.AccessObject);
                        break;
                    case DMSDbType.Mysql:
                        type = typeof(DMST.MysqlObject);
                        break;
                    case DMSDbType.Oracle:
                        type = typeof(DMST.OracleObject);
                        break;
                    case DMSDbType.SQLite:
                        type = typeof(DMST.SQLiteObject);
                        break;
                    default:
                        break;
                }
