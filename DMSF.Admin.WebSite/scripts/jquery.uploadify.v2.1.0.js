		...
		jQuery.extend(jQuery.fn,{
			uploadify:function(options) {
				jQuery(this).each(function(){
					...
					uploader: '/images/base/uploadify.swf', // The path to the uploadify swf file
					script: UploadUrl + 'uploadifyhandler.ashx',
					expressInstall : null, // The path to the express install swf file
					folder         : '', // The path to the upload folder
					height         : 28, // The height of the flash button
                    width: 110, // The width of the flash button
                    buttonImg: '/images/base/btnUpload_img.png',
					cancelImg      : "/images/base/delete.gif",
				...
				if (settings.onInit() !== false) {
					...
					jQuery(this).after('<div id="' + jQuery(this).attr('id') + 'Uploader" style="display:inline"></div>');
