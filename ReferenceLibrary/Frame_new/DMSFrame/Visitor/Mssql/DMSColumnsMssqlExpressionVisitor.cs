...
{
    internal class DMSColumnsMssqlExpressionVisitor : DMSColumnsExpressionVisitor
    {
        #region System.Linq.Expressions.Expression Handle

        protected override System.Linq.Expressions.Expression HandleDistinct(System.Linq.Expressions.MethodCallExpression m)
        {
            this._strSql.Append(this.Provider.Distinct);
