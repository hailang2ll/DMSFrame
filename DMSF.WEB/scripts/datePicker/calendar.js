...
My97DP.prototype = {
    ...
    _fy: function (_, A) {
        ...
        $.a(">&larr;</td><td class='menu' onmouseover=\"this.className='menuOn'\" onmouseout=\"this.className='menu'\" onmousedown=\"hide($d.yD);$d.yI.blur();\">&times;</td><td ");
    ...
    _fillQS: function (A) {
        ...
        if (!A) $.a("<div style=\"float:right;cursor:pointer\" onclick=\"hide($d.qsDivSel);\">×</div>");
        $.a("</td></tr>");
