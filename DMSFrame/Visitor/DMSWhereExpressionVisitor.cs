...
namespace DMSFrame
{
    internal abstract class DMSWhereExpressionVisitor : DMSExpression, IDMSWhereExpression
    {
        ...
        private Type _CurrentMemberType = typeof(object);
        ...
        protected override System.Linq.Expressions.Expression VisitMethodCall(System.Linq.Expressions.MethodCallExpression m)
        {
            ...
            if (DMSExpression.WhereFuncString.Contains(methodName))
            {
                ...
                if (method != null)
                {
                    ...
                    this._CurrentMemberType = exp.Type;
