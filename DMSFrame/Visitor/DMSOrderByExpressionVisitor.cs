...
{
    internal abstract class DMSOrderByExpressionVisitor : DMSExpression, IDMSOrderByExpression
    {
        public int PageIndex { get; set; }

        public int PageSize { get; set; }

        public bool SplitPagerFlag { get; set; }
        ...
        public void Append<T>(OrderByClip<T> orderBy)
        {
            this.AppendColumnExpression(false, typeof(T), orderBy.Expression);
        }
