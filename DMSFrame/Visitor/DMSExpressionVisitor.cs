...
namespace DMSFrame
{
    ...
    /// 
    /// </summary>
    public abstract class DMSExpressionVisitor
    {
        ...
        protected virtual Expression Visit(Expression exp)
        {
            ...
            throw new DMSFrameException(string.Format("Unhandled expression type: '{0}'", exp.NodeType));
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        protected virtual MemberBinding VisitBinding(MemberBinding binding)
        {
            switch (binding.BindingType)
            {
                ...
                default:
                    throw new DMSFrameException(string.Format("Unhandled binding type '{0}'", binding.BindingType));
            }
        }
        /// <summary>
        /// 
        ...
        protected virtual IEnumerable<MemberBinding> VisitBindingList(ReadOnlyCollection<MemberBinding> original)
        {
            ...
            while (i < count)
            {
                ...
                i++;
                VisitBindingList(i, count, original);
            }
            if (list != null)
            {
                return list;
        ...
        /// <param name="original"></param>
        protected virtual void VisitBindingList(int index, int count, ReadOnlyCollection<MemberBinding> original)
        {
